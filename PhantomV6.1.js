(() => {
    ...
    // ==========================================
    // 💀 PHANTOM CONFIG (V6.1 GOD MODE + EXTREME STEALTH)
    // ==========================================
    const CFG = {
        // Hashes de contingencia
        ...
        TIMINGS: { 
            SCAN_BASE: 1000, 
            ACTION_BASE: 4000,
            BATCH_PAUSE: 300000 // 5 Minutos (300,000 ms)
        },
    ...
    const Engine = {
        ...
        extractDynamicHashes() {
            ...
            for (let script of document.scripts) {
                if (script.src && script.src.includes('Consumer')) found++;
            }
        ...
        async engage() {
            ...
            try {
                for (let i = 0; i < targets.length; i++) {
                    ...
                    // ==========================================
                    // LÓGICA DE PAUSA (5 ACCIONES = 5 MINUTOS)
                    // ==========================================
                    let cd = 0;
                    if (Store.state.stats.success > 0 && Store.state.stats.success % 5 === 0) {
                        // 5 minutos + un extra aleatorio de hasta 20 segundos para parecer más real
                        ...
                        // Jitter/Fatiga normal para el resto de las iteraciones
    ...
    (async () => {
        UI.init();
        await Engine.init();
        ErrorHandler.log("⚡ V6.1 GOD MODE ONLINE. Cortafuegos y Regla 5x5 Activa.", "suc");
    })();
})();